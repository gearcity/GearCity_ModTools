...
void ReviewsEditor::on_button_drive_add_clicked()
{
    ...
    if(!rd.localized)
    {
        ...
        {
            QMessageBox::critical(this,"Error","Review is missing {3} Driveability rating text. "
                                  "Your review must contain {3} somewhere in the text.");
           return;
        }
    }
...
void ReviewsEditor::on_button_lux_add_clicked()
{
    ...
    if(!rd.localized)
    {
        ...
        {
            QMessageBox::critical(this,"Error","Review is missing {2} Luxury Rating text. "
                                  "Your review must contain {2} somewhere in the text.");
           return;
        }
    }
...
void ReviewsEditor::on_button_fuel_add_clicked()
{
    ...
    if(!rd.localized)
    {
        ...
        {
            QMessageBox::critical(this,"Error","Review is missing {3} Fuel Consumption Highway text. "
                                  "Your review must contain {3} somewhere in the text.");
           return;
        }
    }
...
void ReviewsEditor::fillQualTable()
{
    ...
    ui->table_qual->setRowCount(reviewsCargo.size());
